...
class BaseModel(ABC):
    ...
    To create a subclass, you need to implement the following five functions:
        ...
        -- <modify_cmd_options>:            (optionally) add model-specific options and set default options.
    """
    def __init__(self, opt):
        ...
        self.save_dir = osp.join(opt.checkpoints_dir, opt.name)  # save all the checkpoints to save_dir
        self.loss_names = []
        self.model_names = []
        self.visual_names = []
        self.optimizers = []
    ...
    def get_current_losses(self):
        """Return traning losses / errors. print out these errors on console and save to a file"""
        errors = OrderedDict()
    ...
    def save_networks(self, epoch):
        ...
        Parameters:
            epoch (int) -- current epoch; used in the file name 'net_%s_%s.pth' % (name, epoch)
        """
        for name in self.model_names:
            if isinstance(name, str):
